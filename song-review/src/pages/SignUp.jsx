...
export default function SignUp() {
    ...
    const handleGoogleLogin = () => {
        // Direct redirect for Google OAuth
        ...
        <div className="w-full min-h-screen bg-black flex items-center justify-center p-4">
            <div className="max-w-md w-full space-y-8 bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-800">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-400">Create an account</p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        >
                            <div className="mr-2">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="block w-4 h-4">
